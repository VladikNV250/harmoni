...
export const feedSlice = createSlice({
    ...
    reducers: {
        setUpdateAfterEveryReload: (state, action: PayloadAction<boolean>) => {
            state.updateAfterEveryReload = action.payload;
        },
        hideRecommendedFeeds: (state, action: PayloadAction<boolean>) => {
            const recommendedFeedsNames = [
                "New Releases",
                "Your Top Artists",
                "Legends of Rock",
                "Icons of Music",
            ...
            recommendedFeedsNames.forEach(feedName => {
                if (state.feeds[feedName]) {
                    state.feeds[feedName].hidden.isHidden = action.payload;
                    state.feeds[feedName].hidden.locked = action.payload;
                }
            })
        },
