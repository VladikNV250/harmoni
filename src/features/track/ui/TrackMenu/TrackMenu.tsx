...
interface ITrackMenu {
    /** Object of track, which will be rendered. */
    ...
    /** Playlist ID to delete track from playlist. Used in the user's playlist pages. */
    readonly playlistId?: string;
}

/**
 * @component TrackMenu
 * @description Responsive menu of TrackItem, which contains additional actions to interact with track. 
 * On desktop (>=768): shows a dropdown context menu.
 * On mobile: shows a bottom sheet.
 * 
 * Additional actions to interact with track:
 * - Adding/removing track from playlist.
 * - Save track in the Spotify library.
 * - Adding track to the playback queue.
 */
